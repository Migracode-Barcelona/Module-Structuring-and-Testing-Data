...
// this expression is a remainder operator will output the remainder after the one operand and the second operand has been divided.
...
//the result evaluates the hours and not the minutes so the variable identifier is wrong. it should be "totalHours" but since that is already defined below we could use "totalmovieHours"
